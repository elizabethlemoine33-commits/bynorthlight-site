...
description: "You made the hire. They're qualified. But you're still doing their work at 11pm. The problem isn't the person — it's the missing structure."
og_title: "You Hired Them. Now What? When New Hires Don't Clear the Bottleneck"
og_description: "You made the hire. They're qualified. But you're still doing their work at 11pm. The problem isn't the person — it's the missing structure."
date: 2026-07-10
...
faq:
  - q: "Why doesn't hiring alone clear the founder bottleneck?"
    a: "Hiring fills a role but doesn't build the structures that let a new person actually do the job: clear authority, explicit decision rights, documented processes. Without those, the founder remains the default approval gate, the new hire stays tentative, and the bottleneck moves sideways rather than clearing. Adding headcount to a system that hasn't defined ownership just adds coordination overhead — more meetings, more handoffs, more places for things to fall through."
  - q: "Why do new hires keep needing the founder in the loop?"
    a: "Three structural failures drive this pattern: hiring for skills but not ownership (the new person defaults to checking with you because the structure makes you the only one who can say yes); the systems that worked when you were solo don't transfer (organisational knowledge lives in your head, not in documented processes); and founders still operating like solo operators even after building a team. These are structural gaps, not personal failures. Structural gaps don't fix by trying harder."
  - q: "What actually fixes the problem when hiring hasn't cleared the bottleneck?"
    a: "Not another hire. What fixes it is building the structure that should have been there before the hire — or building it now, alongside the team you have: clear ownership, explicit decision rights, documented handoffs, and processes that don't live in the founder's head. A fractional engagement — someone outside the team who builds the missing scaffolding while transferring capability — is often the right shape. The goal is not a permanent addition. It's making the people already there able to do the job you hired them for."
---
...
<div class="answer-block"><p>Hiring fills a role but doesn't build the structures that let a new person actually do the job: clear authority, explicit decision rights, documented processes. Without those, the founder remains the default approval gate, the new hire stays tentative, and the bottleneck moves sideways rather than clearing. Adding headcount to a system that hasn't defined ownership just adds coordination overhead — more meetings, more handoffs, more places for things to fall through.</p></div>
...
<div class="answer-block"><p>Three structural failures behind this pattern: hiring for skills but not ownership (the new person defaults to checking with you because the structure makes you the only one who can say yes); the systems that worked when you were solo don't transfer (organisational knowledge lives in your head, not in documented processes); and founders still operating like solo operators even after building a team. These are structural gaps, not personal failures. Structural gaps don't fix by trying harder.</p></div>
...
<div class="answer-block"><p>Not another hire. What fixes it is building the structure that should have been there before the hire — or building it now, alongside the team you have: clear ownership, explicit decision rights, documented handoffs, and processes that don't live in the founder's head. A fractional engagement — someone outside the team who builds the missing scaffolding while transferring capability — is often the right shape. The goal is not a permanent addition. It's making the people already there able to do the job you hired them for.</p></div>
...
Email [support@bynorthlight.ca](mailto:support@bynorthlight.ca) or send me a message on LinkedIn. If it's your 11pm Tuesday, I'd like to hear about it.
